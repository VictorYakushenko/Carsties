...
export default function AuctionFinishedToast({ auction, auctionFinished }: Props) {
    return (
            ...
            <div className='flex flex-row items-center gap-2'>
                ...
                <div className='flex flex-col'>
                    ...
                    {auctionFinished.itemSold && auctionFinished.amount ? (
                        <p>Congrats to {auctionFinished.winner} who has won this auction for
                            $${numberWithCommas(auctionFinished.amount)}</p>
                    ) : (
